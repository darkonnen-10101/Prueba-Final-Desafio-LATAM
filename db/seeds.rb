...
10.times do |i|
  ...
  u = User.create(name: "User#{i}", email:"email#{i}@email.com", password: "123123", avatar: Pathname.new(Rails.root.join('app/assets/images/profile.png')).open, city: "city#{i}", course: @courses[i])
  p = Project.create(user: u, name: "Project#{i}", project_photo: Pathname.new(Rails.root.join('app/assets/images/profile.png')).open, url: "www.google.com", repository: "www.google.com", lead: "lorem ipsum", description: "lorem ipsum")
